...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    self.titleH = [Tools getLableTextHeight:model.title bigestSize:CGSizeMake(kWidth - 90, 500) textFont:15.0];
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(70, 30, kWidth - 90, self.titleH)];
    label1.numberOfLines = 0;
    label1.font = [UIFont systemFontOfSize:15.0];
    label1.text = model.title;
    self.imageArray = model.imageArray;
    for (int i = 0; i < self.imageArray.count; i++) {
        UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(70 + 80 * i, 40 + self.titleH, 60, 60)];
        NSString *str = self.imageArray[i][@"url"];
        [image sd_setImageWithURL:[NSURL URLWithString:str]];
        [cell addSubview:image];
    }
    if (self.imageArray.count == 0) {
        UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(70, 40 + self.titleH, 70, 40)];
        UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(kWidth - 90, 40 + self.titleH, 90, 40)];
        ...
        self.tableView.rowHeight = 80 + self.titleH;
        
    }
    if (self.imageArray.count > 0){
        UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(70, 100 + self.titleH, 70, 40)];
        UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(kWidth - 90, 100 + self.titleH, 90, 40)];
        label2.font = [UIFont systemFontOfSize:13.0];
        label2.textColor = [UIColor grayColor];
        label2.textColor = [UIColor grayColor];
        NSString *str = [Tools getDataFromString:model.time];
        ...
        [cell addSubview:label2];
        [cell addSubview:label3];
        self.tableView.rowHeight = 140 + self.titleH;
    }
